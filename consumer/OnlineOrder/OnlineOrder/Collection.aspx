<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Collection.aspx.cs" Inherits="OnlineOrder.Collection" %>
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" 
                ...
                <Columns>                   
                   <asp:TemplateField HeaderText="商品名称" SortExpression="商品名称">
                    ...
                    <asp:TemplateField HeaderText="商品价格" SortExpression="商品价格"  ItemStyle-Width="300px" ItemStyle-Height="300px">
                        <ItemTemplate>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="pro_id" Text="查看详情"
                      ...
                      <asp:HyperLinkField DataNavigateUrlFields="pro_id" Text="取消收藏"
                      HeaderText="取消收藏" DataNavigateUrlFormatString="pro_id={0}" />
               </Columns>
